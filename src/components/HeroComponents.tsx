...
const HeroComponents = () => {
    return (
        <section className={`${style.flexBetween} ${style.defaultContainer} 
        max-lg:flex-col max-lg:gap-[40px]`}>
            <div className={`flex flex-col`}>
                <h1 className={`${style.titleSize} pb-7`}
                >Awesome tools for <br /> Designer & Developer<span className='text-main'>.</span></h1>
                <p className={`${style.textSize} max-w-[487px] pb-16`}
                >Antool is a web collection of information on paid or free Design and Development tools</p>
                <form
