        ...
        {newcomerCard.map((card) => (
          ...
          >
            ...
            <div className={`flex gap-8 pb-8`}>
              ...
              <div>
                <h2 className={`text-2xl font-medium text-threesColor`}>
                  {card.title}
                </h2>
                <p
                  className={`text-fourColor leading-normal text-lg max-ssm:text-xs`}
                >
                  {card.subTitle}
                </p>
              </div>
            ...
            <div
              className={`${style.flexBetween} max-ldm:flex-col max-ldm:gap-4`}
            >
              ...
              <div className="max-ldm:w-full">
                <ButtonComponents name={button[3]} />
              </div>
            </div>
          </div>
        ))}
